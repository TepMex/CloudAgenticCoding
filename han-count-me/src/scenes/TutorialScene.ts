...
const pages: TutorialPage[] = [
  ...
  },
  {
    ...
    body: 'Нажимай карточки мер или клавиши 1–6. 提示 или H открывает карточку цели и замедляет время втрое. Каждая волна даёт один заряд, а неиспользованные копятся. P и Esc ставят игру на паузу.',
    glyph: '提',
  },
];
