...
extra["sideloadPropertyPrefix"] = "paizhaounknownhanzi"
...
android {
    namespace = "com.tepmex.paizhaounknownhanzi"
    compileSdk = 36
    ...
    defaultConfig {
        applicationId = "com.tepmex.paizhaounknownhanzi"
        minSdk = 34
        targetSdk = 36
...
val downloadOcrModels = tasks.register<Exec>("downloadOcrModels") {
    workingDir = rootProject.projectDir
    commandLine("bash", "scripts/download-ocr-models.sh")
}

tasks.named("preBuild").configure {
    dependsOn(downloadOcrModels)
}
