...
extra["sideloadPropertyPrefix"] = "sameelementandroid"
...
android {
    namespace = "com.tepmex.sameelement"
    compileSdk = 35
    ...
    defaultConfig {
        applicationId = "com.tepmex.sameelement"
        minSdk = 34
        targetSdk = 35
    ...
    // Bundled hanzi JSON can be large; keep packaging quiet.
    packaging {
        resources {
    ...
    doLast {
        if (!wwwIndex.asFile.isFile) {
            throw GradleException(
                "Missing bundled trainer at ${wwwIndex.asFile}. Run ../scripts/sync-web-assets.sh first.",
            )
        }
    }
}
