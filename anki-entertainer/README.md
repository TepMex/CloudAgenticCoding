...
When the LLM is not configured or unreachable (no chunks generated yet), the main screen falls back to **up to 5 local mnemonic stories** for Han compounds and characters in the vocabulary.
